...
if (! cmdreader->is_complete()) {
    throw(Heimdali::NotImplementedError("Streaming not supported"));
}
...
if ( sx%2 != 0)
    throw(Heimdali::NotImplementedError("Number of columns must be even"));
unsigned int sy = size[YD];
if ( sy%2 != 0)
    throw(Heimdali::NotImplementedError("Number of rows must be even"));
