Feature: Chain commands with unix pipes.
    ...
    Scenario: bi reads from stdin
        When I run the command: cat $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 | bi -n 1 > out.5
    ...
    Scenario: Read from previous command output
        When I run the command: so $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 | bi -n 1 | sc -n 2 > out.h5
        Then the HDF5 files out.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2_two.h5 are equal
