Feature: par
    ...
    Scenario: Print all parameters
        ...
        Then I see the standard output:
            """
            imtest_z5_y4_x3_c2.<ext> -x 3	-y 4	-z 5	-v 2	-o 4	-r
            ""
            """
    Examples:
      | ext |
    ...
    Scenario: Print parameters of image with origin different than 0
        ...
        Then I see the standard output:
            """
            imtest_z5_y4_x3_c2_origin_4_5_6.<ext> -x 3	-y 4	-z 5	-v 2	-x0 4	-y0 5	-z0 6	-o 4	-r
            ""
            """
    Examples:
      | ext |
    ...
    Scenario: Print parameters of image with one plane and one pixel component
        ...
        Then I see the standard output:
            """
            imtest_z1_y3_x2_c1.<ext> -x 2	-y 3	-o 4	-r
            ""
            """
    Examples:
      | ext |
