Feature: fzoom
    ...
    Scenario: Enlarge an image, and reduce it.
        ...
        Then the HDF5 files fzoom_out0.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2_fzoom_2.h5 are equal
        When I run the command: fzoom -sc 0.5 fzoom_out0.h5 fzoom_out1.h5
        #Then the HDF5 files fzoom_out1.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 are equal
