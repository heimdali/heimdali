Feature: vb
    ...
    Scenario: Threshold an image
        When I run the command: vb -t 0.5 -v 2. $HEIMDALI_DATA_DIR/cossin_z5_y5_x5_c2_r4.<ext> cossin_z5_y5_x5_c2_r4_vb_0_5.<ext>
    ...
    Scenario: Read from standard input and write to standard output
        When I run the command: cat $HEIMDALI_DATA_DIR/cossin_z5_y5_x5_c2_r4.h5 | vb -t 0.5 -v 2 > cossin_z5_y5_x5_c2_r4_vb_0_5_sdtin.h5
