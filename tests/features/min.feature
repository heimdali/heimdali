Feature: min
    ...
    Scenario: Minimum of two fixed-point images
        When I run the command: min $HEIMDALI_DATA_DIR/three_values_f1.<ext> $HEIMDALI_DATA_DIR/three_values_f1.<ext> | tpr -c
