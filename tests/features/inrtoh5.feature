Feature: inrtoh5
    ...
    Scenario: Convert from HDF5 to INRimage, and back to HDF5, with image of 1 plane and 1 pixel component
        When I run the command: h5toinr $HEIMDALI_DATA_DIR/imtest_z1_y3_x2_c1.h5 imtest_z1_y3_x2_c1.inr 
        When I run the command: inrtoh5 imtest_z1_y3_x2_c1.inr imtest_z1_y3_x2_c1.h5 
