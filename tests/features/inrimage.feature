Feature: inrimage
    ...
    Scenario: Run the inrimage_write.cxx example
        ...
        Then the HDF5 files inrimage_write_0.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 are equal
        Then the HDF5 files inrimage_write_1.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 are equal
        Then the HDF5 files inrimage_write_2.h5 and $HEIMDALI_DATA_DIR/imtest_z5_y4_x3_c2.h5 are equal
